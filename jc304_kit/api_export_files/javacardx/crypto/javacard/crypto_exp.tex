export file {		// javacardx/crypto
	...
	constant_pool {
		...
		Constant_Classref_info {
			tag	7
			name_index	102		// javacardx/crypto/Cipher
		}
		Constant_Utf8_info {
			tag	1
			length	16
		...
		CONSTANT_Package_info {
			tag	13
			flags	1
			name_index	104		// javacardx/crypto
			minor_version	5
			major_version	1
			aid_length	7
	...
	export_classes {
		...
		class_info {		// javacardx/crypto/Cipher
			token	1
			access_flags	public abstract
			name_index	103		// javacardx/crypto/Cipher
			export_supers_count	1
			supers {
				constant_pool_index	7		// java/lang/Object
			}
			...
			methods {
				method_info {
					token	0
					access_flags	public static final
					name_index	87		// getInstance
					Descriptor_Index	88		// (BZ)Ljavacardx/crypto/Cipher;
				}
				method_info {
					token	2
					access_flags	public static final
					name_index	87		// getInstance
					Descriptor_Index	89		// (BBZ)Ljavacardx/crypto/Cipher;
				}
				method_info {
					token	1
					access_flags	protected
					name_index	90		// <init>
					Descriptor_Index	91		// ()V
				}
				method_info {
					token	0
					access_flags	public
				...
				method_info {
					token	1
					access_flags	public abstract
					name_index	94		// doFinal
					Descriptor_Index	95		// ([BSS[BS)S
				}
				method_info {
					token	2
					access_flags	public abstract
					name_index	96		// getAlgorithm
				...
				method_info {
					...
					access_flags	public abstract
					name_index	98		// init
					Descriptor_Index	99		// (Ljavacard/security/Key;B)V
				}
				method_info {
					token	4
					access_flags	public abstract
					name_index	98		// init
					Descriptor_Index	100		// (Ljavacard/security/Key;B[BSS)V
				}
				method_info {
					token	5
					access_flags	public abstract
					name_index	101		// update
					Descriptor_Index	95		// ([BSS[BS)S
				}
			}
