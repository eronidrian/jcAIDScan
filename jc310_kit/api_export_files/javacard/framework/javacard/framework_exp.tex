export file {		// javacard/framework
	...
	constant_pool {
		...
		Constant_Classref_info {
			tag	7
			name_index	128		// java/lang/Throwable
		}
		Constant_Utf8_info {
			tag	1
			length	19
		...
		Constant_Classref_info {
			tag	7
			name_index	130		// java/lang/Exception
		}
		Constant_Utf8_info {
			tag	1
			length	26
		...
		Constant_Classref_info {
			tag	7
			name_index	132		// java/lang/RuntimeException
		}
		Constant_Utf8_info {
			tag	1
			length	22
		...
		Constant_Classref_info {
			tag	7
			name_index	191		// javacard/framework/JCSystem
		}
		Constant_Utf8_info {
			tag	1
			length	11
		...
		Constant_Classref_info {
			tag	7
			name_index	203		// javacard/framework/APDUException
		}
		Constant_Utf8_info {
			tag	1
			length	5
		...
		Constant_Classref_info {
			tag	7
			name_index	209		// javacard/framework/OwnerPIN
		}
		Constant_Utf8_info {
			tag	1
			length	9
		...
		Constant_Classref_info {
			tag	7
			name_index	216		// javacard/framework/OwnerPINBuilder
		}
		Constant_Utf8_info {
			tag	1
			length	7
		...
		Constant_Classref_info {
			tag	7
			name_index	225		// javacard/framework/Applet
		}
		Constant_Utf8_info {
			tag	1
			length	13
		...
		Constant_Classref_info {
			tag	7
			name_index	288		// javacard/framework/APDU
		}
		Constant_Utf8_info {
			tag	1
			length	32
		...
		Constant_Classref_info {
			tag	7
			name_index	290		// javacard/framework/CardException
		}
		Constant_Utf8_info {
			tag	1
			length	13
		...
		Constant_Classref_info {
			tag	7
			name_index	294		// javacard/framework/PINException
		}
		Constant_Utf8_info {
			tag	1
			length	12
		...
		Constant_Classref_info {
			tag	7
			name_index	302		// javacard/framework/Resources
		}
		Constant_Utf8_info {
			tag	1
			length	15
		...
		Constant_Classref_info {
			tag	7
			name_index	311		// javacard/framework/SensitiveArrays
		}
		Constant_Utf8_info {
			tag	1
			length	31
		...
		Constant_Classref_info {
			tag	7
			name_index	313		// javacard/framework/ISOException
		}
		Constant_Utf8_info {
			tag	1
			length	18
		...
		Constant_Classref_info {
			tag	7
			name_index	319		// javacard/framework/SystemException
		}
		Constant_Utf8_info {
			tag	1
			length	11
		...
		Constant_Classref_info {
			tag	7
			name_index	325		// javacard/framework/TransactionException
		}
		Constant_Utf8_info {
			tag	1
			length	32
		...
		Constant_Classref_info {
			tag	7
			name_index	327		// javacard/framework/UserException
		}
		Constant_Utf8_info {
			tag	1
			length	9
		...
		Constant_Classref_info {
			tag	7
			name_index	343		// javacard/framework/Util
		}
		Constant_Utf8_info {
			tag	1
			length	18
		...
		CONSTANT_Package_info {
			tag	13
			flags	1
			name_index	345		// javacard/framework
			minor_version	8
			major_version	1
			aid_length	7
	...
	referencedPackage[0]	348		// java/lang
	...
	export_classes {
		...
		class_info {		// javacard/framework/PIN
			...
			methods {
				method_info {
					...
					access_flags	public abstract
					name_index	87		// check
					Descriptor_Index	88		// ([BSB)Z
				}
				method_info {
					token	1
					access_flags	public abstract
					name_index	89		// getTriesRemaining
					Descriptor_Index	90		// ()B
				}
				method_info {
					token	2
					access_flags	public abstract
		...
		class_info {		// javacard/framework/AID
			token	6
			access_flags	public
			name_index	120		// javacard/framework/AID
			export_supers_count	1
			supers {
				constant_pool_index	5		// java/lang/Object
			}
			...
			methods {
				...
				method_info {
					...
					name_index	110		// equals
					Descriptor_Index	111		// (Ljava/lang/Object;)Z
				}
				method_info {
					token	1
					access_flags	public final
					name_index	112		// RIDEquals
					Descriptor_Index	113		// (Ljavacard/framework/AID;)Z
				}
				method_info {
					token	2
					access_flags	public final
				...
				method_info {
					token	3
					access_flags	public final
					name_index	114		// getBytes
					Descriptor_Index	115		// ([BS)B
				}
				method_info {
					token	4
					access_flags	public final
					name_index	116		// partialEquals
					Descriptor_Index	88		// ([BSB)Z
				}
				method_info {
					token	5
					access_flags	public final
					name_index	117		// getPartialBytes
					Descriptor_Index	118		// (S[BSB)B
				}
			}
		...
		class_info {		// javacard/framework/CardRuntimeException
			token	5
			access_flags	public
			name_index	127		// javacard/framework/CardRuntimeException
			export_supers_count	4
			supers {
				constant_pool_index	5		// java/lang/Object
				constant_pool_index	129		// java/lang/Throwable
				constant_pool_index	131		// java/lang/Exception
				constant_pool_index	133		// java/lang/RuntimeException
			}
			export_interfaces_count	0
			interfaces {
			}
			...
			methods {
				method_info {
					...
					access_flags	public
					name_index	109		// <init>
					Descriptor_Index	121		// (S)V
				}
				method_info {
					token	1
					access_flags	public static
					name_index	122		// throwIt
					Descriptor_Index	121		// (S)V
				}
				method_info {
					token	0
				...
				method_info {
					token	1
					access_flags	public
					name_index	123		// getReason
					Descriptor_Index	124		// ()S
				}
				method_info {
					token	2
					access_flags	public
					name_index	125		// setReason
					Descriptor_Index	121		// (S)V
				}
			}
		...
		class_info {		// javacard/framework/JCSystem
			token	8
			access_flags	public final
			name_index	192		// javacard/framework/JCSystem
			export_supers_count	1
			supers {
				constant_pool_index	5		// java/lang/Object
			}
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	134		// MEMORY_TYPE_PERSISTENT
				Descriptor_Index	60		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	135		// MEMORY_TYPE_TRANSIENT_RESET
				Descriptor_Index	60		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	136		// MEMORY_TYPE_TRANSIENT_DESELECT
				Descriptor_Index	60		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	137		// ARRAY_TYPE_BOOLEAN
				Descriptor_Index	60		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	138		// ARRAY_TYPE_BYTE
				Descriptor_Index	60		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	139		// ARRAY_TYPE_SHORT
				Descriptor_Index	60		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	141		// ARRAY_TYPE_OBJECT
				Descriptor_Index	60		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	142		// ATTR_READABLE_VIEW
				Descriptor_Index	7		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	143		// ATTR_WRITABLE_VIEW
				Descriptor_Index	7		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	144		// NOT_A_TRANSIENT_OBJECT
				Descriptor_Index	60		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	146		// CLEAR_ON_DESELECT
				Descriptor_Index	60		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			methods {
				method_info {
					token	10
					access_flags	public static
					name_index	147		// isTransient
					Descriptor_Index	148		// (Ljava/lang/Object;)B
				}
				method_info {
					token	12
					access_flags	public static
					name_index	149		// makeTransientBooleanArray
					Descriptor_Index	150		// (SB)[Z
				}
				method_info {
					token	13
					access_flags	public static
					name_index	151		// makeTransientByteArray
					Descriptor_Index	152		// (SB)[B
				}
				method_info {
					token	15
					access_flags	public static
					name_index	153		// makeTransientShortArray
					Descriptor_Index	154		// (SB)[S
				}
				method_info {
					token	14
					access_flags	public static
					name_index	155		// makeTransientObjectArray
					Descriptor_Index	156		// (SB)[Ljava/lang/Object;
				}
				method_info {
					token	21
					access_flags	public static
					name_index	157		// makeGlobalArray
					Descriptor_Index	158		// (BS)Ljava/lang/Object;
				}
				method_info {
					token	23
					access_flags	public static
					name_index	159		// makeArrayView
					Descriptor_Index	160		// (Ljava/lang/Object;SSSLjavacard/framework/Shareable;)Ljava/lang/Object;
				}
				method_info {
					token	26
					access_flags	public static
					name_index	161		// makeBooleanArrayView
					Descriptor_Index	162		// ([ZSSSLjavacard/framework/Shareable;)[Z
				}
				method_info {
					token	27
					access_flags	public static
					name_index	163		// makeByteArrayView
					Descriptor_Index	164		// ([BSSSLjavacard/framework/Shareable;)[B
				}
				method_info {
					token	28
					access_flags	public static
					name_index	165		// makeShortArrayView
					Descriptor_Index	166		// ([SSSSLjavacard/framework/Shareable;)[S
				}
				method_info {
					token	24
					access_flags	public static
					name_index	167		// isArrayView
					Descriptor_Index	111		// (Ljava/lang/Object;)Z
				}
				method_info {
					token	25
					access_flags	public static
					name_index	168		// getAttributes
					Descriptor_Index	169		// (Ljava/lang/Object;)S
				}
				method_info {
					token	9
					access_flags	public static
					name_index	170		// getVersion
					Descriptor_Index	124		// ()S
				}
				method_info {
					token	3
					access_flags	public static
					name_index	171		// getAID
					Descriptor_Index	172		// ()Ljavacard/framework/AID;
				}
				method_info {
					token	11
					access_flags	public static
					name_index	173		// lookupAID
					Descriptor_Index	174		// ([BSB)Ljavacard/framework/AID;
				}
				method_info {
					token	1
					access_flags	public static
					name_index	175		// beginTransaction
					Descriptor_Index	1		// ()V
				}
				method_info {
					token	0
					access_flags	public static
					name_index	176		// abortTransaction
					Descriptor_Index	1		// ()V
				}
				method_info {
					token	2
					access_flags	public static
					name_index	177		// commitTransaction
					Descriptor_Index	1		// ()V
				}
				method_info {
					token	7
					access_flags	public static
					name_index	178		// getTransactionDepth
					Descriptor_Index	90		// ()B
				}
				method_info {
					token	8
					access_flags	public static
					name_index	179		// getUnusedCommitCapacity
					Descriptor_Index	124		// ()S
				}
				method_info {
					token	5
					access_flags	public static
					name_index	180		// getMaxCommitCapacity
					Descriptor_Index	124		// ()S
				}
				method_info {
					token	6
					access_flags	public static
					name_index	181		// getPreviousContextAID
					Descriptor_Index	172		// ()Ljavacard/framework/AID;
				}
				method_info {
					token	16
					access_flags	public static
					name_index	182		// getAvailableMemory
					Descriptor_Index	183		// (B)S
				}
				method_info {
					token	22
					access_flags	public static
					name_index	182		// getAvailableMemory
					Descriptor_Index	184		// ([SSB)V
				}
				method_info {
					token	4
					access_flags	public static
					name_index	185		// getAppletShareableInterfaceObject
					Descriptor_Index	186		// (Ljavacard/framework/AID;B)Ljavacard/framework/Shareable;
				}
				method_info {
					token	17
					access_flags	public static
					name_index	187		// isObjectDeletionSupported
					Descriptor_Index	92		// ()Z
				}
				method_info {
					token	18
					access_flags	public static
					name_index	188		// requestObjectDeletion
					Descriptor_Index	1		// ()V
				}
				method_info {
					token	19
					access_flags	public static
					name_index	189		// getAssignedChannel
					Descriptor_Index	90		// ()B
				}
				method_info {
					token	20
					access_flags	public static
					name_index	190		// isAppletActive
					Descriptor_Index	113		// (Ljavacard/framework/AID;)Z
				}
				method_info {
					token	0
		...
		class_info {		// javacard/framework/APDUException
			token	12
			access_flags	public
			name_index	204		// javacard/framework/APDUException
			...
			supers {
				...
				constant_pool_index	131		// java/lang/Exception
				constant_pool_index	133		// java/lang/RuntimeException
				constant_pool_index	127		// javacard/framework/CardRuntimeException
			}
			export_interfaces_count	0
			interfaces {
			}
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	197		// NO_T0_GETRESPONSE
				Descriptor_Index	7		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	8		// ConstantValue
					attribute_length	2
					constantvalue_index	198		// value = 170
				}
				}
			}
			field_info {
				...
				ConstantValue_attribute {
					attribute_name_index	8		// ConstantValue
					attribute_length	2
					constantvalue_index	200		// value = 171
				}
				}
			}
			field_info {
				...
				ConstantValue_attribute {
					attribute_name_index	8		// ConstantValue
					attribute_length	2
					constantvalue_index	202		// value = 172
				}
				}
			}
			}
		...
		class_info {		// javacard/framework/OwnerPIN
			token	9
			access_flags	public
			name_index	210		// javacard/framework/OwnerPIN
			export_supers_count	1
			supers {
				constant_pool_index	5		// java/lang/Object
			}
			...
			methods {
				...
				method_info {
					...
					name_index	206		// getValidatedFlag
					Descriptor_Index	92		// ()Z
				}
				method_info {
					token	4
				...
				method_info {
					token	6
					access_flags	public
					name_index	207		// resetAndUnblock
					Descriptor_Index	1		// ()V
				}
				method_info {
					token	7
					access_flags	protected
					name_index	208		// setValidatedFlag
					Descriptor_Index	84		// (Z)V
				}
				method_info {
					token	8
		...
		class_info {		// javacard/framework/OwnerPINBuilder
			token	21
			access_flags	public
			name_index	217		// javacard/framework/OwnerPINBuilder
			export_supers_count	1
			supers {
				constant_pool_index	5		// java/lang/Object
			}
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	213		// OWNER_PIN_X_WITH_PREDECREMENT
				Descriptor_Index	60		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			methods {
				method_info {
					token	0
					access_flags	public static
					name_index	214		// buildOwnerPIN
					Descriptor_Index	215		// (BBB)Ljavacard/framework/PIN;
				}
				method_info {
					token	0
					access_flags	public
		...
		class_info {		// javacard/framework/Applet
			token	3
			access_flags	public abstract
			name_index	226		// javacard/framework/Applet
			export_supers_count	1
			supers {
				constant_pool_index	5		// java/lang/Object
			}
			...
			methods {
				...
				method_info {
					token	1
					access_flags	public static
					name_index	218		// install
					Descriptor_Index	97		// ([BSB)V
				}
				method_info {
					token	2
					access_flags	protected static
					name_index	219		// reSelectingApplet
					Descriptor_Index	92		// ()Z
				}
				method_info {
					token	0
				...
				method_info {
					token	3
					access_flags	protected final
					name_index	221		// selectingApplet
					Descriptor_Index	92		// ()Z
				}
				method_info {
					token	4
				...
				method_info {
					token	5
					access_flags	public
					name_index	222		// getShareableInterfaceObject
					Descriptor_Index	186		// (Ljavacard/framework/AID;B)Ljavacard/framework/Shareable;
				}
				method_info {
					token	6
				...
				method_info {
					token	7
					access_flags	public abstract
					name_index	223		// process
					Descriptor_Index	224		// (Ljavacard/framework/APDU;)V
				}
			}
		...
		class_info {		// javacard/framework/APDU
			token	10
			access_flags	public final
			name_index	289		// javacard/framework/APDU
			export_supers_count	1
			supers {
				constant_pool_index	5		// java/lang/Object
			}
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	228		// STATE_PARTIAL_INCOMING
				Descriptor_Index	60		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	229		// STATE_FULL_INCOMING
				Descriptor_Index	60		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	231		// STATE_OUTGOING_LENGTH_KNOWN
				Descriptor_Index	60		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	232		// STATE_PARTIAL_OUTGOING
				Descriptor_Index	60		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	233		// STATE_FULL_OUTGOING
				Descriptor_Index	60		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	8		// ConstantValue
					attribute_length	2
					constantvalue_index	234		// value = 6
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	235		// STATE_ERROR_NO_T0_GETRESPONSE
				Descriptor_Index	60		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	8		// ConstantValue
					attribute_length	2
					constantvalue_index	236		// value = -1
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	237		// STATE_ERROR_T1_IFD_ABORT
				Descriptor_Index	60		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	8		// ConstantValue
					attribute_length	2
					constantvalue_index	238		// value = -2
				}
				}
			}
			field_info {
				...
				ConstantValue_attribute {
					attribute_name_index	8		// ConstantValue
					attribute_length	2
					constantvalue_index	240		// value = -3
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	241		// STATE_ERROR_NO_T0_REISSUE
				Descriptor_Index	60		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	8		// ConstantValue
					attribute_length	2
					constantvalue_index	242		// value = -4
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	243		// PROTOCOL_MEDIA_MASK
				Descriptor_Index	60		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	8		// ConstantValue
					attribute_length	2
					constantvalue_index	244		// value = -16
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	245		// PROTOCOL_TYPE_MASK
				Descriptor_Index	60		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	8		// ConstantValue
					attribute_length	2
					constantvalue_index	246		// value = 15
				}
				}
			}
			field_info {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	249		// PROTOCOL_MEDIA_DEFAULT
				Descriptor_Index	60		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	250		// PROTOCOL_MEDIA_CONTACTLESS_TYPE_A
				Descriptor_Index	60		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	8		// ConstantValue
					attribute_length	2
					constantvalue_index	251		// value = -128
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	252		// PROTOCOL_MEDIA_CONTACTLESS_TYPE_B
				Descriptor_Index	60		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	8		// ConstantValue
					attribute_length	2
					constantvalue_index	253		// value = -112
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	254		// PROTOCOL_MEDIA_USB
				Descriptor_Index	60		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	8		// ConstantValue
					attribute_length	2
					constantvalue_index	255		// value = -96
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	256		// PROTOCOL_MEDIA_HCI_APDU_GATE
				Descriptor_Index	60		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	8		// ConstantValue
					attribute_length	2
					constantvalue_index	257		// value = -80
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	258		// PROTOCOL_MEDIA_CONTACTLESS_TYPE_F
				Descriptor_Index	60		// B
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			methods {
				method_info {
					token	0
					access_flags	public static
					name_index	259		// getInBlockSize
					Descriptor_Index	124		// ()S
				}
				method_info {
					token	1
					access_flags	public static
					name_index	260		// getOutBlockSize
					Descriptor_Index	124		// ()S
				}
				method_info {
					token	2
					access_flags	public static
					name_index	261		// getProtocol
					Descriptor_Index	90		// ()B
				}
				method_info {
					token	4
					access_flags	public static
					name_index	262		// getCurrentAPDU
					Descriptor_Index	263		// ()Ljavacard/framework/APDU;
				}
				method_info {
					token	5
					access_flags	public static
					name_index	264		// getCurrentAPDUBuffer
					Descriptor_Index	265		// ()[B
				}
				method_info {
					token	6
					access_flags	public static
					name_index	266		// getCLAChannel
					Descriptor_Index	90		// ()B
				}
				method_info {
					token	3
					access_flags	public static
					name_index	267		// waitExtension
					Descriptor_Index	1		// ()V
				}
				method_info {
					token	0
				...
				method_info {
					token	1
					access_flags	public
					name_index	268		// getBuffer
					Descriptor_Index	265		// ()[B
				}
				method_info {
					token	2
					access_flags	public
					name_index	269		// getNAD
					Descriptor_Index	90		// ()B
				}
				method_info {
					token	3
					access_flags	public
					name_index	270		// receiveBytes
					Descriptor_Index	271		// (S)S
				}
				method_info {
					token	4
					access_flags	public
					name_index	272		// sendBytes
					Descriptor_Index	273		// (SS)V
				}
				method_info {
					token	5
					access_flags	public
					name_index	274		// sendBytesLong
					Descriptor_Index	275		// ([BSS)V
				}
				method_info {
					token	6
					access_flags	public
					name_index	276		// setIncomingAndReceive
					Descriptor_Index	124		// ()S
				}
				method_info {
					token	7
					access_flags	public
					name_index	277		// setOutgoing
					Descriptor_Index	124		// ()S
				}
				method_info {
					token	8
					access_flags	public
					name_index	278		// setOutgoingAndSend
					Descriptor_Index	273		// (SS)V
				}
				method_info {
					token	9
					access_flags	public
					name_index	279		// setOutgoingLength
					Descriptor_Index	121		// (S)V
				}
				method_info {
					token	10
					access_flags	public
					name_index	280		// setOutgoingNoChaining
					Descriptor_Index	124		// ()S
				}
				method_info {
					token	11
					access_flags	public
					name_index	281		// getCurrentState
					Descriptor_Index	90		// ()B
				}
				method_info {
					token	12
					access_flags	public
					name_index	282		// isCommandChainingCLA
					Descriptor_Index	92		// ()Z
				}
				method_info {
					token	13
					access_flags	public
					name_index	283		// isSecureMessagingCLA
					Descriptor_Index	92		// ()Z
				}
				method_info {
					token	14
					access_flags	public
					name_index	284		// isISOInterindustryCLA
					Descriptor_Index	92		// ()Z
				}
				method_info {
					token	15
					access_flags	public
					name_index	285		// getIncomingLength
					Descriptor_Index	124		// ()S
				}
				method_info {
					token	16
					access_flags	public
					name_index	286		// getOffsetCdata
					Descriptor_Index	124		// ()S
				}
				method_info {
					token	17
					access_flags	public
					name_index	287		// isValidCLA
					Descriptor_Index	92		// ()Z
				}
			}
		...
		class_info {		// javacard/framework/CardException
			token	4
			access_flags	public
			name_index	291		// javacard/framework/CardException
		...
		class_info {		// javacard/framework/PINException
			token	11
			access_flags	public
			name_index	295		// javacard/framework/PINException
			export_supers_count	5
			supers {
				constant_pool_index	5		// java/lang/Object
				constant_pool_index	129		// java/lang/Throwable
		...
		class_info {		// javacard/framework/Resources
			token	23
			access_flags	public final
			name_index	303		// javacard/framework/Resources
			export_supers_count	1
			supers {
				constant_pool_index	5		// java/lang/Object
			}
			...
			methods {
				method_info {
					token	0
					access_flags	public static
					name_index	296		// getResources
					Descriptor_Index	297		// ()Ljavacard/framework/Resources;
				}
				method_info {
					token	0
					access_flags	public
				...
				method_info {
					token	1
					access_flags	public
					name_index	298		// getSize
					Descriptor_Index	271		// (S)S
				}
				method_info {
					token	2
					access_flags	public
					name_index	299		// getView
					Descriptor_Index	300		// (S)[B
				}
				method_info {
					token	3
					access_flags	public
					name_index	299		// getView
					Descriptor_Index	301		// (SSS)[B
				}
			}
		...
		class_info {		// javacard/framework/SensitiveArrays
			token	22
			access_flags	public
			name_index	312		// javacard/framework/SensitiveArrays
			export_supers_count	1
			supers {
				constant_pool_index	5		// java/lang/Object
			}
			...
			methods {
				method_info {
					token	0
					access_flags	public static
					name_index	304		// assertIntegrity
					Descriptor_Index	305		// (Ljava/lang/Object;)V
				}
				method_info {
					token	1
					access_flags	public static
					name_index	306		// isIntegritySensitive
					Descriptor_Index	111		// (Ljava/lang/Object;)Z
				}
				method_info {
					token	2
					access_flags	public static
					name_index	307		// isIntegritySensitiveArraysSupported
					Descriptor_Index	92		// ()Z
				}
				method_info {
					token	3
					access_flags	public static
					name_index	308		// makeIntegritySensitiveArray
					Descriptor_Index	309		// (BBS)Ljava/lang/Object;
				}
				method_info {
					token	4
					access_flags	public static
					name_index	310		// clearArray
					Descriptor_Index	169		// (Ljava/lang/Object;)S
				}
				method_info {
					token	0
		...
		class_info {		// javacard/framework/ISOException
			token	7
			access_flags	public
			name_index	314		// javacard/framework/ISOException
			export_supers_count	5
			supers {
				constant_pool_index	5		// java/lang/Object
				constant_pool_index	129		// java/lang/Throwable
		...
		class_info {		// javacard/framework/SystemException
			token	13
			access_flags	public
			name_index	320		// javacard/framework/SystemException
			export_supers_count	5
			supers {
				constant_pool_index	5		// java/lang/Object
				constant_pool_index	129		// java/lang/Throwable
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	315		// NO_TRANSIENT_SPACE
				Descriptor_Index	7		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	316		// ILLEGAL_TRANSIENT
				Descriptor_Index	7		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
		...
		class_info {		// javacard/framework/TransactionException
			token	14
			access_flags	public
			name_index	326		// javacard/framework/TransactionException
			export_supers_count	5
			supers {
				constant_pool_index	5		// java/lang/Object
				constant_pool_index	129		// java/lang/Throwable
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	322		// NOT_IN_PROGRESS
				Descriptor_Index	7		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
			...
			field_info {
				token	255
				access_flags	public static final
				name_index	324		// INTERNAL_FAILURE
				Descriptor_Index	7		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
		...
		class_info {		// javacard/framework/UserException
			token	15
			access_flags	public
			name_index	328		// javacard/framework/UserException
			export_supers_count	4
			supers {
				constant_pool_index	5		// java/lang/Object
				constant_pool_index	129		// java/lang/Throwable
				constant_pool_index	131		// java/lang/Exception
				constant_pool_index	291		// javacard/framework/CardException
			}
			export_interfaces_count	0
			interfaces {
			}
		...
		class_info {		// javacard/framework/Util
			token	16
			access_flags	public
			name_index	344		// javacard/framework/Util
			export_supers_count	1
			supers {
				constant_pool_index	5		// java/lang/Object
			}
			...
			methods {
				method_info {
					token	1
					access_flags	public static final
					name_index	329		// arrayCopy
					Descriptor_Index	330		// ([BS[BSS)S
				}
				method_info {
					token	2
					access_flags	public static final
					name_index	331		// arrayCopyNonAtomic
					Descriptor_Index	330		// ([BS[BSS)S
				}
				method_info {
					token	7
					access_flags	public static final
					name_index	332		// arrayFill
					Descriptor_Index	333		// ([BSSB)S
				}
				method_info {
					token	3
					access_flags	public static final
					name_index	334		// arrayFillNonAtomic
					Descriptor_Index	333		// ([BSSB)S
				}
				method_info {
					token	0
					access_flags	public static final
					name_index	335		// arrayCompare
					Descriptor_Index	336		// ([BS[BSS)B
				}
				method_info {
					token	5
					access_flags	public static final
					name_index	337		// makeShort
					Descriptor_Index	338		// (BB)S
				}
				method_info {
					token	4
					access_flags	public static final
					name_index	339		// getShort
					Descriptor_Index	340		// ([BS)S
				}
				method_info {
					token	6
					access_flags	public static final
					name_index	341		// setShort
					Descriptor_Index	342		// ([BSS)S
				}
				method_info {
					token	0
					access_flags	public
