export file {		// javacardx/crypto
	...
	constant_pool {
		...
		Constant_Classref_info {
			tag	7
			name_index	126		// javacardx/crypto/Cipher
		}
		Constant_Utf8_info {
			tag	1
			length	4
		...
		Constant_Classref_info {
			tag	7
			name_index	131		// javacardx/crypto/Cipher$OneShot
		}
		Constant_Utf8_info {
			tag	1
			length	14
		...
		Constant_Classref_info {
			tag	7
			name_index	148		// javacardx/crypto/AEADCipher
		}
		Constant_Utf8_info {
			tag	1
			length	16
		...
		CONSTANT_Package_info {
			tag	13
			flags	1
			name_index	150		// javacardx/crypto
			minor_version	7
			major_version	1
			aid_length	7
		...
		CONSTANT_Package_info {
			tag	13
			flags	0
			name_index	154		// javacard/security
			minor_version	7
			major_version	1
			aid_length	7
	...
	referencedPackage[0]	153		// java/lang
	referencedPackage[1]	155		// javacard/security
	...
	export_classes {
		...
		class_info {		// javacardx/crypto/Cipher
			token	1
			access_flags	public abstract
			name_index	127		// javacardx/crypto/Cipher
			export_supers_count	1
			supers {
				constant_pool_index	7		// java/lang/Object
			}
			...
			field_info {
				...
				ConstantValue_attribute {
					attribute_name_index	10		// ConstantValue
					attribute_length	2
					constantvalue_index	104		// value = -16
				}
				}
			}
			field_info {
				...
				ConstantValue_attribute {
					attribute_name_index	10		// ConstantValue
					attribute_length	2
					constantvalue_index	106		// value = 28
				}
				}
			}
			field_info {
				...
				ConstantValue_attribute {
					attribute_name_index	10		// ConstantValue
					attribute_length	2
					constantvalue_index	108		// value = 29
				}
				}
			}
			}
			...
			methods {
				method_info {
					token	0
					access_flags	public static final
					name_index	109		// getInstance
					Descriptor_Index	110		// (BZ)Ljavacardx/crypto/Cipher;
				}
				method_info {
					token	2
					access_flags	public static final
					name_index	109		// getInstance
					Descriptor_Index	111		// (BBZ)Ljavacardx/crypto/Cipher;
				}
				method_info {
					token	1
					access_flags	protected
					name_index	112		// <init>
					Descriptor_Index	113		// ()V
				}
				method_info {
					token	0
					access_flags	public
					name_index	114		// equals
					Descriptor_Index	115		// (Ljava/lang/Object;)Z
				}
				method_info {
					token	1
					access_flags	public abstract
					name_index	116		// doFinal
					Descriptor_Index	117		// ([BSS[BS)S
				}
				method_info {
					token	2
					access_flags	public abstract
					name_index	118		// getAlgorithm
					Descriptor_Index	119		// ()B
				}
				method_info {
					token	3
					access_flags	public abstract
					name_index	120		// init
					Descriptor_Index	121		// (Ljavacard/security/Key;B)V
				}
				method_info {
					token	4
					access_flags	public abstract
					name_index	120		// init
					Descriptor_Index	122		// (Ljavacard/security/Key;B[BSS)V
				}
				method_info {
					token	5
					access_flags	public abstract
					name_index	123		// update
					Descriptor_Index	117		// ([BSS[BS)S
				}
				method_info {
					token	6
					access_flags	public abstract
					name_index	124		// getCipherAlgorithm
					Descriptor_Index	119		// ()B
				}
				method_info {
					token	7
					access_flags	public abstract
					name_index	125		// getPaddingAlgorithm
					Descriptor_Index	119		// ()B
				}
			}
		...
		class_info {		// javacardx/crypto/Cipher$OneShot
			...
			name_index	132		// javacardx/crypto/Cipher$OneShot
			export_supers_count	2
			supers {
				constant_pool_index	7		// java/lang/Object
				constant_pool_index	127		// javacardx/crypto/Cipher
			}
			export_interfaces_count	0
			interfaces {
			}
			...
			methods {
				method_info {
					...
					access_flags	public static final
					name_index	128		// open
					Descriptor_Index	129		// (BB)Ljavacardx/crypto/Cipher$OneShot;
				}
				method_info {
					token	0
					access_flags	public
		...
		class_info {		// javacardx/crypto/AEADCipher
			token	3
			access_flags	public abstract
			name_index	149		// javacardx/crypto/AEADCipher
			export_supers_count	2
			supers {
				constant_pool_index	7		// java/lang/Object
				constant_pool_index	127		// javacardx/crypto/Cipher
			...
			field_info {
				...
				ConstantValue_attribute {
					attribute_name_index	10		// ConstantValue
					attribute_length	2
					constantvalue_index	134		// value = -15
				}
				}
			}
			field_info {
				...
				ConstantValue_attribute {
					attribute_name_index	10		// ConstantValue
					attribute_length	2
					constantvalue_index	136		// value = -14
				}
				}
			}
			field_info {
				...
				ConstantValue_attribute {
					attribute_name_index	10		// ConstantValue
					attribute_length	2
					constantvalue_index	138		// value = -13
				}
				}
			}
			field_info {
				...
				ConstantValue_attribute {
					attribute_name_index	10		// ConstantValue
					attribute_length	2
					constantvalue_index	140		// value = -12
				}
				}
			}
			}
			...
			methods {
				...
				method_info {
					...
					access_flags	public abstract
					name_index	120		// init
					Descriptor_Index	141		// (Ljavacard/security/Key;B[BSSSSS)V
				}
				method_info {
					token	9
					access_flags	public abstract
					name_index	142		// updateAAD
					Descriptor_Index	143		// ([BSS)V
				}
				method_info {
					token	10
					access_flags	public abstract
					name_index	144		// retrieveTag
					Descriptor_Index	145		// ([BSS)S
				}
				method_info {
					token	11
					access_flags	public abstract
					name_index	146		// verifyTag
					Descriptor_Index	147		// ([BSSS)Z
				}
			}
