export file {		// javacardx/security/derivation
	...
	constant_pool {
		...
		Constant_Classref_info {
			tag	7
			name_index	36		// javacardx/security/derivation/TLSPseudoRandomFunctionSpec
		}
		Constant_Utf8_info {
			tag	1
			length	20
		...
		Constant_Classref_info {
			tag	7
			name_index	70		// javacardx/security/derivation/DerivationFunction
		}
		Constant_Utf8_info {
			tag	1
			length	4
		...
		Constant_Classref_info {
			tag	7
			name_index	75		// javacardx/security/derivation/DerivationFunction$OneShot
		}
		Constant_Utf8_info {
			tag	1
			length	29
		...
		CONSTANT_Package_info {
			tag	13
			flags	1
			name_index	77		// javacardx/security/derivation
			minor_version	0
			major_version	1
			aid_length	8
		...
		CONSTANT_Package_info {
			tag	13
			flags	0
			name_index	81		// javacard/security
			minor_version	7
			major_version	1
			aid_length	7
	...
	referencedPackage[1]	82		// javacard/security
	export_class_count	10
	export_classes {
		...
		class_info {		// javacardx/security/derivation/TLSPseudoRandomFunctionSpec
			token	7
			access_flags	public abstract interface
			name_index	37		// javacardx/security/derivation/TLSPseudoRandomFunctionSpec
			export_supers_count	1
			supers {
				constant_pool_index	10		// java/lang/Object
			}
		...
		class_info {		// javacardx/security/derivation/DerivationFunction
			token	8
			access_flags	public abstract
			name_index	71		// javacardx/security/derivation/DerivationFunction
			export_supers_count	1
			supers {
				constant_pool_index	10		// java/lang/Object
			}
			...
			field_info {
				...
				name_index	38		// ALG_KDF_COUNTER_MODE
				Descriptor_Index	39		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	40		// ConstantValue
					attribute_length	2
					constantvalue_index	41		// value = 1
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	42		// ALG_KDF_DPI_MODE
				Descriptor_Index	39		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	40		// ConstantValue
					attribute_length	2
					constantvalue_index	43		// value = 2
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	44		// ALG_KDF_FEEDBACK_MODE
				Descriptor_Index	39		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	40		// ConstantValue
					attribute_length	2
					constantvalue_index	45		// value = 3
				}
				}
			}
			field_info {
				...
				ConstantValue_attribute {
					attribute_name_index	40		// ConstantValue
					attribute_length	2
					constantvalue_index	47		// value = 4
				}
				}
			}
			field_info {
				...
				ConstantValue_attribute {
					attribute_name_index	40		// ConstantValue
					attribute_length	2
					constantvalue_index	49		// value = 5
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	50		// ALG_KDF_IEEE_1363
				Descriptor_Index	39		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	40		// ConstantValue
					attribute_length	2
					constantvalue_index	51		// value = 6
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	52		// ALG_KDF_ICAO_MRTD
				Descriptor_Index	39		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	40		// ConstantValue
					attribute_length	2
					constantvalue_index	53		// value = 7
				}
				}
			}
			field_info {
				token	255
				access_flags	public static final
				name_index	54		// ALG_KDF_ANSI_X9_63
				Descriptor_Index	39		// S
				attributes_count	1
				attributes {
				ConstantValue_attribute {
					attribute_name_index	40		// ConstantValue
					attribute_length	2
					constantvalue_index	55		// value = 8
				}
				}
			}
			field_info {
				...
				ConstantValue_attribute {
					attribute_name_index	40		// ConstantValue
					attribute_length	2
					constantvalue_index	57		// value = 9
				}
				}
			}
			}
			...
			methods {
				method_info {
					...
					name_index	58		// <init>
					Descriptor_Index	59		// ()V
				}
				method_info {
					token	1
					access_flags	public static
					name_index	60		// getInstance
					Descriptor_Index	61		// (SZ)Ljavacardx/security/derivation/DerivationFunction;
				}
				method_info {
					token	0
					access_flags	public
					name_index	62		// equals
					Descriptor_Index	63		// (Ljava/lang/Object;)Z
				}
				method_info {
					token	1
					access_flags	public abstract
					name_index	64		// init
					Descriptor_Index	65		// (Ljavacard/security/AlgorithmParameterSpec;)V
				}
				method_info {
					token	2
					access_flags	public abstract
				...
				method_info {
					...
					access_flags	public abstract
					name_index	66		// nextBytes
					Descriptor_Index	68		// (Ljavacard/security/SecretKey;)S
				}
				method_info {
					token	5
					access_flags	public abstract
					name_index	69		// lastBytes
					Descriptor_Index	67		// ([BSS)S
				}
				method_info {
					token	6
		...
		class_info {		// javacardx/security/derivation/DerivationFunction$OneShot
			...
			name_index	76		// javacardx/security/derivation/DerivationFunction$OneShot
			export_supers_count	2
			supers {
				constant_pool_index	10		// java/lang/Object
				constant_pool_index	71		// javacardx/security/derivation/DerivationFunction
			}
			export_interfaces_count	0
			interfaces {
			}
			...
			methods {
				method_info {
					...
					access_flags	public static final
					name_index	72		// open
					Descriptor_Index	73		// (B)Ljavacardx/security/derivation/DerivationFunction$OneShot;
				}
				method_info {
					token	0
					access_flags	public
